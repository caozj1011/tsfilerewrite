...
public class TsFileRewrite {
    ...
    public static void main(String[] args) throws IOException, WriteProcessException {
        new TsFileRewrite("/Users/caozhijia/Desktop/timecho/code/tsfilerewrite/src/main/resources/1681835759143-1-0-0.tsfile", "/Users/caozhijia/Desktop/timecho/code/tsfilerewrite/src/main/resources/out.tsfile").parseAndRewriteFile();
    }
            ...
            while ((marker = reader.readMarker()) != MetaMarker.SEPARATOR) {
                switch (marker) {
                    ...
                    case MetaMarker.ONLY_ONE_PAGE_CHUNK_HEADER:
                        ...
                        while (dataSize > 0) {
                            // a new Page
                            PageHeader pageHeader = reader.readPageHeader(dataType, header.getChunkType() == MetaMarker.CHUNK_HEADER);
...
//                        deviceId = "root.db.newdevice";
                        reWriteChunk(deviceId, firstChunkInChunkGroup, measurementSchema, pageHeadersInChunk, dataInChunk);
            ...
            throw new IOException("TsFile rewrite process cannot proceed at position " + reader.position() + "because: " + e2.getMessage());
        } finally {
            if (reader != null) {
                reader.close();
            }
    ...
    protected void reWriteChunk(String deviceId, boolean firstChunkInChunkGroup, MeasurementSchema schema, List<PageHeader> pageHeadersInChunk, List<ByteBuffer> pageDataInChunk) throws IOException, PageException {
